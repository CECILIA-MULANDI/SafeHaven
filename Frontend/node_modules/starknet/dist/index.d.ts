...
type StateUpdate$1 = STATE_UPDATE | PENDING_STATE_UPDATE;
...
declare class RpcProvider$1 implements ProviderInterface {
    ...
    getTransactionByHash(txHash: BigNumberish): Promise<TransactionWithHash>;
    getTransactionByBlockIdAndIndex(blockIdentifier: BlockIdentifier, index: number): Promise<TransactionWithHash>;
    getTransactionReceipt(txHash: BigNumberish): Promise<INVOKE_TXN_RECEIPT | PENDING_INVOKE_TXN_RECEIPT | DECLARE_TXN_RECEIPT | PENDING_DECLARE_TXN_RECEIPT | DEPLOY_ACCOUNT_TXN_RECEIPT | PENDING_DEPLOY_ACCOUNT_TXN_RECEIPT | DEPLOY_TXN_RECEIPT | L1_HANDLER_TXN_RECEIPT | PENDING_L1_HANDLER_TXN_RECEIPT>;
    getTransactionTrace(txHash: BigNumberish): Promise<TRANSACTION_TRACE>;
    /**
     * Get the status of a transaction
     */
 ...
 * }
 */
declare function byteArrayFromString(myString: string): ByteArray;
